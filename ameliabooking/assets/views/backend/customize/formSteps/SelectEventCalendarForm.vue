...
export default {
  ...
  data () {
    return {
      ...
      labelSpots: this.formStepData.labels.event_spots,
  ...
  methods: {
    ...
    calendarEventBlock (eventInfo) {
      ...
      let spotsText = `${eventInfo.event.extendedProps.places} ${eventInfo.event.extendedProps.places === 1 ? (this.labelsDisplay(this.labelSpot, this.languageShortCode) || this.$root.labels.event_spot) : (this.labelsDisplay(this.labelSpots, this.languageShortCode) || this.$root.labels.event_spots)}`
  ...
  watch: {
    'formStepData' () {
      ...
      this.labelSpots = this.formStepData.labels.event_spots
