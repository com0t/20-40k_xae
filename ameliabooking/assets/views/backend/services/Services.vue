<template>
  <div class="am-wrap">
    <div id="am-services" class="am-body">
      ...
      <!-- Button New -->
      <div v-if="categories.length > 0 && $root.settings.capabilities.canWrite === true && !showPurchasedPackages" id="am-button-new" class="am-button-new">
        <el-button
          id="am-plus-symbol"
          type="primary"
          icon="el-icon-plus"
...
export default {
    ...
    mixins: [liteMixin, imageMixin, dateMixin, durationMixin, priceMixin, notifyMixin, settingsMixin, stashMixin],
