  ...
  <div>
    <div class="am-dialog-scrollable">
      ...
      <el-form :model="settings" ref="settings" :rules="rules" label-position="top" @submit.prevent="onSubmit">
          ...
          <el-row type="flex" align="middle" :gutter="24">
            ...
            <el-col :span="8" class="align-right">
              <el-switch
                  ...
                  :disabled="(!this.settings.payPal.enabled && !this.settings.stripe.enabled && !this.settings.mollie.enabled && !this.settings.wc.enabled) || this.settings.wc.enabled"
                  active-text=""
                  inactive-text=""
                  @change="toggleOnSite"
              >
        ...
        <el-collapse v-show="(settings.wc.enabled || settings.stripe.enabled || settings.payPal.enabled || settings.mollie.enabled)">
...
<script>
  ...
  export default {
    ...
    components: {PaymentsMetaData, SelectTranslate}
