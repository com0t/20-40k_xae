      ...
      <div class="am-payment-details">
        ...
        <el-row class="am-payment-details-row">
          ...
          <el-col :span="12">
            ...
            <p class="am-semi-strong">
              <img class="svg-amelia" width="14px" :src="$root.getUrl + 'public/img/payments/' + payment.gateway + '.svg'">
        ...
        <el-row class="am-payment-details-row am-payment-summary">
          <el-col :span="12">
            ...
            <p v-if="modalData.bookableType !== 'package'">{{ $root.labels.extras }}</p>
            <p v-if="modalData.bookableType !== 'package'">{{ $root.labels.subtotal }}</p>
            <p v-if="modalData.bookableType !== 'package'">{{ $root.labels.discount_amount }}</p>
          ...
          <el-col :span="12">
            ...
            <p v-if="modalData.bookableType !== 'package'" class="am-semi-strong">{{ getFormattedPrice(finance.extrasPriceTotal) }}</p>
            <p v-if="modalData.bookableType !== 'package'" class="am-semi-strong">{{ getFormattedPrice(finance.subTotal) }}</p>
            <p v-if="modalData.bookableType !== 'package'" class="am-semi-strong">{{ getFormattedPrice(finance.discountTotal) }}</p>
