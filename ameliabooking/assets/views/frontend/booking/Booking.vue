...
<script>
  ...
  export default {
    ...
    mixins: [cacheMixin, formsCustomizationMixin, packageMixin, recurringMixin, imageMixin, dateMixin, entitiesMixin, bookingMixin, helperMixin, durationMixin, priceMixin, customFieldMixin, settingsMixin],
    ...
    methods: {
      ...
      showCalendarOnly (initCall) {
        ...
        return initCall &&
          ...
          (!serviceProviderVisibility || (providerService !== null && (providerService.maxCapacity === 1 || providerService.bringingAnyone === false))) &&
