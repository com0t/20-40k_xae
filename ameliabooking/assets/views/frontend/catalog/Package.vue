<template>
  <div id="amelia-booking-wrap" class="am-wrap">
    ...
    <!-- Package -->
    <div id="am-service-booking" ref="bookingContainer" v-if="package && package.status === 'visible'">
              ...
              >
                <el-row v-for="bookable in package.availableBookableInfo" :key="bookable.serviceId">
                  <el-col :span="16" class="am-package-service" :style="{color: formColors.formTextColor}">
                    {{ bookable.serviceName }} <span :style="{color: formColors.formTextColor}">x{{ bookable.serviceQuantity }}</span>
                  </el-col>
                </el-row>
              </el-col>
            </el-row>
