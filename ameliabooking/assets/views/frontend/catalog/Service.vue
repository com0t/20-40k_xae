<template>
  <div id="amelia-booking-wrap" class="am-wrap">
    ...
    <!-- Service -->
    <div id="am-service-booking" ref="bookingContainer" v-if="service && service.status === 'visible'">
          ...
          <div class="am-service" :style="{backgroundColor: formColors.formBackgroundColor}">
            ...
            <div class="am-service-header">
              ...
              <div class="am-service-data">
                <!-- Service Back -->
                <div
                  v-if="$root.shortcodeData.booking !== null && $root.shortcodeData.booking.service === null"
    ...
    <!-- Spinner -->
    <div class="am-loader" v-show="!fetchedService">
...
export default {
  ...
  created () {
    ...
    this.serviceId = 'service' in this.$root.shortcodeData.booking ? this.$root.shortcodeData.booking.service : null
